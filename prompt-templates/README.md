...
*   [user-research-questionnaire](./user-research-questionnaire/): Template for designing decision-focused user research questionnaires with screening, branching, and response-quality checks.
